package com.mybank.ReportingService.constants;
...
public class AppConstants {
    ...
    static public final String QUEUE_ACCOUNT = "bank-user-account";
    static public final String QUEUE_TRANSACTION = "bank-user-transaction";
